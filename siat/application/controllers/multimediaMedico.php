...
class multimediaMedico extends CI_Controller{
    ...
    public function videos(){
        ...
        $this->load->view("multimedia/videosMedico", $this->data);
    }
    
    public function pdf(){
        $this->data["pdf"] = $this->multimedia_model->getPdf();
        $this->load->view("multimedia/pdfMedico", $this->data);
    }
    
    public function addVideo(){
        $this->multimedia_model->addVideo();
         $this->notificaciones_model->notificationWithIdPacienteAll($this->data['data']['idUsuario'],
                   "Nueva Archivo Multimedia", "index.php/multimedia/videos", "icon-play");
        redirect(base_url()."index.php/multimediaMedico/videos");
    }
    ...
    public function subirPDF(){
        ...
        if (!$this->upload->do_upload()){
            ...
            redirect(base_url()."index.php/multimediaMedico/pdf/");
        }
    }
