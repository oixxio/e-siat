...
class prescripcionesObrasocial extends CI_Controller{
    ...
    public function index(){
        $this->data['prescripciones'] = $this->prescripciones_model->getPrescripcionesObraSocial($this->data['data']['idObraSocial']);
        $this->load->view("obrasocial/prescripciones/principal", $this->data);
    }
    
    public function entregada($id){
        $this->prescripciones_model->setEntregada(
                $id,
                $this->input->post("cantidadUI"),
                $this->input->post("fecha"),
                $this->input->post("hora"),
				$this->input->post("lote"));
        redirect(base_url()."index.php/prescripcionesObrasocial");
    }
