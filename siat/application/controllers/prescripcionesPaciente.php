...
class prescripcionesPaciente extends CI_Controller{
    
    
    public function __construct() {
        parent::__construct();
        $this->load->model("prescripciones_model");
    ...
    public function index(){
        ...
        $this->data['prescripciones'] = 
                $this->prescripciones_model->getPrescripciones($this->data['data']['idPaciente']);
        
        $this->load->view("prescripciones/principal", $this->data);
        
    }
    
    public function setRecibida($idPresc){
        
        $this->prescripciones_model->setRecibida(
                $idPresc,
        ...
        redirect(base_url()."index.php/prescripcionesPaciente");
