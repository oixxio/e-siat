...
class turnosPaciente extends CI_Controller{
    
    
    public function __construct() {
        parent::__construct();
        $this->load->model("turnospaciente_model");
    ...
    public function index(){
        $this->data['turnos'] = $this->turnospaciente_model->getTurnos($this->data['data']['idPaciente']);
        $this->load->view("turnos/turnosPaciente", $this->data);
    }
    
    public function cambiar($id){
        $fecha = $this->input->post("fecha");
        $hora = $this->input->post("hora");
        $this->turnospaciente_model->solicitudCambio($id, $fecha, $hora);
        redirect(base_url()."index.php/turnosPaciente/index");
    }
    
    public function eliminar($id){
        $this->turnospaciente_model->solicitudCancelacion($id);
        redirect(base_url()."index.php/turnosPaciente/index");
    }
    
    
    public function resolicitud($id){
        $this->turnospaciente_model->resolicitud($id);
        redirect(base_url()."index.php/turnosPaciente/index");
    }
