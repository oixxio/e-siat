<html>
                            ...
                            <table class="table-striped span12">
                                ...
                                <tbody>
                                    <?php foreach ($prescripciones as $p) { ?>
                                        ...
                                        <tr <?php if ($p->entregada != 1) { ?> class='setRecibida' href='#setRecibida' data-id='<?= $p->id ?>' data-toggle='modal' <?php } ?>>
                                            <td>
                                                <?= $p->nombre." ".$p->apellido  ?>
                                            </td>
                                            <td>
    ...
    <form id='recibida' action="<?= base_url() ?>index.php/prescripcionesObrasocial/entregada" method="POST">
        <div id="setRecibida" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel">Confirmar Prescripcion Entregada</h3>
            </div>
    ...
    <script>
        $(document).ready(function(){
            $(".setRecibida").click(function(){
                $("#recibida").attr("action", "<?= base_url() ?>index.php/prescripcionesObrasocial/entregada/"+$(this).data("id"));
            });
        });
    </script>
</html>
