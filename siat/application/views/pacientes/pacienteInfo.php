                ...
                <div class="tabbable tabs-stacked">
                    ...
                    <div class="tab-content" style="margin-bottom: 50px">
                        ...
                        <div class="tab-pane" id="B">
                            ...
                            <?php } ?>
                            <div class="row-fluid">
                                <form action="<?= base_url() ?>index.php/pacientes/upload/<?= $idPaciente ?>" method="POST" enctype="multipart/form-data">
                                    <div class="span12">
        ...
        $(function() {
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                eventClick: function(calEvent, jsEvent, view) {
                    ...
                    var template = _.template($("#dosis_info_sheet").html());
...
<script type="text/plain" id="dosis_info_sheet" >
    <div>
        <div>
