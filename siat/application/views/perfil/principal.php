<html>
                        ...
                        <div class="tabbable tabs-stacked">
                            ...
                            <div class="tab-content" style="margin-bottom: 50px">
                                <div class="tab-pane active" id="A">
                                    ...
                                    <div class="row-fluid">
                                        <div class="span14">
                                            <form action="<?= base_url() ?>index.php/perfil/actualizarData" method="POST">
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <h4>Nombre</h4>
                                                    ...
                                                    <div class="span6">
                                                        <h4>Apellido</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->apellido ?></h5>
                                                        <input name="apellido" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="tel" value="<?= $perfil->apellido ?>" />
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row-fluid">
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <h4>Telefono Personal</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->telefono_personal ?></h5>
                                                        <input name="telefonoPersonal" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="tel" value="<?= $perfil->telefono_personal ?>" />
                                                    </div>
                                                    <div class="span6">
                                                        <h4>Telefono Casa</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->telefono_casa ?></h5>
                                                        <input name="telefonoCasa" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="tel" value="<?= $perfil->telefono_casa ?>" />
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <h4>Telefono Oficina</h4>
                                                    ...
                                                    <div class="span6">
                                                        <h4>Genero</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->genero ?></h5>
                                                        <input name="genero" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="text" value="<?= $perfil->genero ?>" />
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <h4>Lugar de Nacimineto</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->lugar_nacimiento ?></h5>
                                                        <input name="lugarNacimiento" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="text" value="<?= $perfil->lugar_nacimiento ?>" />
                                                    </div>
                                                    <div class="span6">
                                                        <h4>Fecha de Nacimiento</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->fecha_nacimiento ?></h5>
                                                        <input name="fechaNacimiento" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="date" value="<?= $perfil->fecha_nacimiento ?>" />
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <h4>Titulo</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->titulo ?></h5>
                                                        <input name="titulo" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="text" value="<?= $perfil->titulo ?>" />
                                                    </div>
                                                    <div class="span6">
                                                        <h4>Codigo Postal</h4>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <h4>Edad</h4>
                                                        <h5 class="non-editable-perfil"><?= $perfil->edad ?></h5>
                                                        <input name="edad" class="input-xlarge editable_perfil" style="height: 30px; display: none" type="text" value="<?= $perfil->edad ?>" />
                                                    </div>
                                                    <div class="span6">
                                ...
                                <div class="tab-pane" id="B">
                                    <form action="<?= base_url() ?>index.php/perfil/updatePass" method="POST"> 
                                        <div  class="row-fluid">
    ...
    <form id='recibida' action="<?= base_url() ?>index.php/perfil/cambiarImagenPerfil" method="POST" enctype="multipart/form-data" >
        <div id="cambiarImagen" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel">Cambar Imagen de Perfil</h3>
            </div>
